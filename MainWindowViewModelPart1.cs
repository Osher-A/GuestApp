...
namespace GuestApp.ViewModel
{
    public partial class MainWindowViewModel : INotifyPropertyChanged
    {
        ...
        private ObservableCollection<DTO.Guest> _familyGuests;
        public ObservableCollection<DTO.Guest> FamilyGuests
        {
            get { return _familyGuests; }
            set
            {
                _familyGuests = value;
                RaisePropertyChanged("FamilyGuests");
            }
        }
